...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private com.netcracker.edu.fapi.security.TokenProvider tokenProvider;
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
        String header = httpServletRequest.getHeader(com.netcracker.edu.fapi.security.SecurityJwtConstants.HEADER_STRING);
        String userName = null;
        String authToken = null;
        if (header != null && header.startsWith(com.netcracker.edu.fapi.security.SecurityJwtConstants.TOKEN_PREFIX)) {
            authToken = header.replace(com.netcracker.edu.fapi.security.SecurityJwtConstants.TOKEN_PREFIX, "");
            try {
